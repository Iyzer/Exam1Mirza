# -*- coding: utf-8 -*-
"""Exam1Part1-MIRZA.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1ZJokA21GiQnZ8I71EVvuCl0KmoQxDyG6
...
plt.pyplot.hist(df["horsepower"], color='skyblue')
...
pyplot.bar(group_names, df["horsepower-binned"].value_counts(), color=colors)
...
n, bins, patches = pyplot.hist(df["horsepower"], bins=3)
...
# Write your code below and press Shift+Enter to execute
aspiration_dummies = pd.get_dummies(df["aspiration"], prefix="asp")
...
# Load the notebook
notebook_path = "/content/drive/MyDrive/EXAM1/Exam1Part1-MIRZA.ipynb"
output_html_path = "/content/drive/MyDrive/EXAM1/Exam1Part1-MIRZA.html"
...
# Save the converted HTML to file
